  ...
  const reviews = [
    {
      ...
      rating: 5,
      comment: "Absolutely amazing! The pasta was perfect and the service was exceptional. The Carbonara was the best I've ever had outside of Italy.",
      source: "google",
      approved: true,
    },
    {
      ...
      rating: 5,
      comment: "Best Italian restaurant in town. The Osso Buco was incredible! The risotto was perfectly creamy and the veal was tender.",
      source: "yelp",
      approved: true,
    },
    {
      ...
      rating: 4,
      comment: "Great atmosphere and delicious food. Will definitely come back! The wine selection is impressive.",
      source: "website",
      approved: true,
    },
    {
      ...
      rating: 5,
      comment: "Authentic Italian flavors that remind me of my trip to Rome. The Tiramisu is heavenly!",
      source: "website",
      approved: true,
    },
    {
      ...
      rating: 5,
      comment: "Perfect date night spot! Romantic ambiance, excellent service, and the Branzino was cooked to perfection.",
      source: "google",
      approved: true,
    },
    {
      ...
      rating: 4,
      comment: "Great food and friendly staff. The Lasagna alla Bolognese is a must-try. Will return soon!",
      source: "website",
      approved: true,
    },
    {
      ...
      rating: 5,
      comment: "Outstanding experience from start to finish. The Arancini appetizer was delightful, and the main courses were exceptional.",
      source: "yelp",
      approved: true,
    },
    {
      ...
      rating: 5,
      comment: "The Risotto ai Funghi was incredible! Creamy, flavorful, and perfectly seasoned. Best Italian restaurant in the area.",
      source: "google",
      approved: true,
    },
    {
      ...
      rating: 4,
      comment: "Lovely restaurant with authentic Italian cuisine. The Caprese salad was fresh and the pizza was excellent.",
      source: "website",
      approved: true,
    },
    {
      ...
      rating: 5,
      comment: "Exceptional dining experience! The Cannoli Siciliani was the perfect ending to a wonderful meal. Highly recommend!",
      source: "yelp",
      approved: true,
    },
  ];
